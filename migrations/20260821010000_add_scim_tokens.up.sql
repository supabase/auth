...
-- prefix is the leading, non-secret span of the token, kept so an admin can tell
-- two live tokens apart during rotation. Nullable until AUTH-1365 mints tokens.
