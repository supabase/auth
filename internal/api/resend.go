...
func (a *API) Resend(w http.ResponseWriter, r *http.Request) error {
	...
	err = db.Transaction(func(tx *storage.Connection) error {
		...
		case smsVerification:
			...
			return a.sendPhoneConfirmation(ctx, tx, user, params.Phone, phoneConfirmationOtp, smsProvider, sms_provider.SMSProvider, models.ImplicitFlow)
		case emailChangeVerification:
		...
		case phoneChangeVerification:
			...
			return a.sendPhoneConfirmation(ctx, tx, user, params.Phone, phoneChangeVerification, smsProvider, sms_provider.SMSProvider, models.ImplicitFlow)
		}
		return nil
	})
	if err != nil {
