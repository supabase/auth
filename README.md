...
We support `apple`, `azure`, `bitbucket`, `discord`, `facebook`, `figma`, `github`, `gitlab`, `google`, `keycloak`, `linkedin`, `notion`, `pinterest`, `spotify`, `slack`, `twitch`, `twitter` and `workos` for external authentication.
...
```
provider=apple | azure | bitbucket | discord | facebook | figma | github | gitlab | google | keycloak | linkedin | notion | pinterest | slack | spotify | twitch | twitter | workos
